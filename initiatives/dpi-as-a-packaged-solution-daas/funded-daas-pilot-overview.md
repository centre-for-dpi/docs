...
Applications are open from **January to February 2024**, and selected countries will be given their <mark style="background-color:purple;">**DaaS packages as well as supplementary funding for pilot rollouts**</mark> by March 2024. All pilots will be live on the ground within 90 days after that. The pilots will operate for a period of 90 days after the go-live date. If its pilot objectives are successfully met (the country and DPG will pre-decide what 'success' looks like for them), then they can choose to extend the pilot for another 90 days or start the transition to scale. There can be a maximum of two extensions possible of 90 days each, resulting in a total run-time of 12 months. &#x20;
